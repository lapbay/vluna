...
import { SeatBillingService } from './services/seat-billing.service.js'
...
@Module({
  imports: [AuthModule],
  controllers: [GateController, SeatsController, GatePolicyBundlesController, GatePoliciesController],
  providers: [GateService, SeatService, SeatBillingService, GatePolicyBundlesService, GatePoliciesService, BudgetService, LeaseService, PricingService, QuotaService, SettlementService, GateIdempotencyService, GrantBalanceService, BillingPeriodService],
  exports: [GateService, SettlementService, SeatBillingService],
})
